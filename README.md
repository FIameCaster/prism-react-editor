...
| `textareaProps`     | `React.TextareaHTMLAttributes<HTMLTextAreaElement>`                                   | Allows adding props to the editor's textarea element. [Unsupported props](https://github.com/FIameCaster/prism-react-editor/blob/9b8fe37a01b1376b25a3f6aa95573ca9d7bcc816/src/types.ts#L41) |
